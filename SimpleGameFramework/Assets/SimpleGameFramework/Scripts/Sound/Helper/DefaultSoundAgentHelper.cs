...
namespace SimpleGameFramework.Sound
{
    ...
    public class DefaultSoundAgentHelper : SoundAgentHelperBase
    {
        ...
        private void Update()
        {
            if (!IsPlaying && m_AudioSource.clip != null && resetSoundAgentEventHandler != null)
            {
                resetSoundAgentEventHandler(this, new ResetSoundAgentEventArgs());
                return;
            }
        ...
        private void UpdateAgentPosition()
        {
            ...
            if (resetSoundAgentEventHandler != null)
            {
                resetSoundAgentEventHandler(this, new ResetSoundAgentEventArgs());
            }
        }
